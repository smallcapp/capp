...
enum {
    __debug_level_ok        = (1<<0),
    __debug_level_bug       = (1<<1),
    __debug_level_error     = (1<<2),
    __debug_level_trace     = (1<<3),
    __debug_level_init      = (1<<4),
    __debug_level_config    = (1<<5),
    __debug_level_lib       = (1<<6),
    __debug_level_io        = (1<<7),
    __debug_level_timer     = (1<<8),
    __debug_level_timeout   = (1<<9),
    __debug_level_aging     = (1<<10),
    __debug_level_event     = (1<<11),
    __debug_level_entry     = (1<<12),
    __debug_level_packet    = (1<<13),
    __debug_level_flow      = (1<<14),
    __debug_level_signal    = (1<<15),
    __debug_level_shell     = (1<<16),
    __debug_level_test      = (1<<17),
    __debug_level_consume   = (1<<18),
};
...
#define __debug_level_default   (__debug_level_error | __debug_level_bug)
#endif
...
#define __is_debug_level(_level)    (os_hasflag(__debug_level, _level))
...
#define __is_debug_level_init       __is_debug_level(__debug_level_init)
#define __is_debug_level_config     __is_debug_level(__debug_level_config)
#define __is_debug_level_lib        __is_debug_level(__debug_level_lib)
...
#define __is_debug_level_aging      __is_debug_level(__debug_level_aging)
...
#define __is_debug_level_flow       __is_debug_level(__debug_level_flow)
...
#define __vdebug_init(_fmt, _args)      __jvdlogger(jlog_vprintf, __debug_level_init, _fmt, _args)
#define __vdebug_config(_fmt, _args)    __jvdlogger(jlog_vprintf, __debug_level_config, _fmt, _args)
#define __vdebug_lib(_fmt, _args)       __jvdlogger(jlog_vprintf, __debug_level_lib, _fmt, _args)
...
#define __vdebug_aging(_fmt, _args)     __jvdlogger(jlog_vprintf, __debug_level_aging, _fmt, _args)
...
#define __vdebug_flow(_fmt, _args)      __jvdlogger(jlog_vprintf, __debug_level_flow, _fmt, _args)
...
#define __debug_init(_fmt, _args...)    __jdlogger(jlog_printf, __debug_level_init, _fmt, ##_args)
#define __debug_config(_fmt, _args...)  __jdlogger(jlog_printf, __debug_level_config, _fmt, ##_args)
#define __debug_lib(_fmt, _args...)     __jdlogger(jlog_printf, __debug_level_lib, _fmt, ##_args)
...
#define __debug_aging(_fmt, _args...)   __jdlogger(jlog_printf, __debug_level_aging, _fmt, ##_args)
...
#define __debug_flow(_fmt, _args...)    __jdlogger(jlog_printf, __debug_level_flow, _fmt, ##_args)
...
#define vdebug_init(_fmt, _args)        jvdlogger(__debug_level_init, _fmt, _args)
#define vdebug_config(_fmt, _args)      jvdlogger(__debug_level_config, _fmt, _args)
#define vdebug_lib(_fmt, _args)         jvdlogger(__debug_level_lib, _fmt, _args)
...
#define vdebug_aging(_fmt, _args)       jvdlogger(__debug_level_aging, _fmt, _args)
...
#define vdebug_flow(_fmt, _args)        jvdlogger(__debug_level_flow, _fmt, _args)
...
#define debug_init(_fmt, _args...)      jdlogger(__debug_level_init, _fmt, ##_args)
#define debug_config(_fmt, _args...)    jdlogger(__debug_level_config, _fmt, ##_args)
#define debug_lib(_fmt, _args...)       jdlogger(__debug_level_lib, _fmt, ##_args)
...
#define debug_aging(_fmt, _args...)     jdlogger(__debug_level_aging, _fmt, ##_args)
...
#define debug_flow(_fmt, _args...)      jdlogger(__debug_level_flow, _fmt, ##_args)
